...
class ListingForm extends Component {
  ...
  onChangeImages(e) {
    ...
    if (e.target.files.length > 5) {
      ...
      for(var x = 0; x < e.target.files.length; x++) {
        if (e.target.files[x].size > 1000*1000) {
  ...
  onChangeLengthUnit(e) {
    this.setState({ lengthUnit: e.target.value})
  }
  ...
  setEditingCells = (value) => {
    this.setState({ editingCells: value })
  };
  ...
  onSubmit(e) {
    ...
    if (this.state.images.length < 1) {
      this.setState({ emptyImage: true })
    } else if (this.state.contact.instagram === '' && this.state.contact.facebook === '' && this.state.contact.twitter === '' && this.state.contact.reddit === ''
      && this.state.contact.snapchat === '' && this.state.contact.wechat === '' && this.state.contact.phone === '' && this.state.contact.email === '') {
      ...
      .then(res =>
        this.listing(res.data.features[0].center)
      )
  ...
  render() {
      const badQuant = this.state.emptyImage || this.state.tooMany
        ...
        <Container>
            <Form onSubmit={this.onSubmit} encType="multipart/form-data" className="mt-2">
              <Form.Group as={Row} controlId="formHorizontalTitle">
                ...
                <Col sm={10}>
                  <Form.Control value={this.state.title} onChange={this.onChangeTitle} required/>
                </Col>
              </Form.Group>
              ...
              <Form.Group as={Row} controlId="formHorizontalAddress">
                ...
                <Col sm={10}>
                    <Form.Control value={this.state.address} onChange={this.onChangeAddress} required/>
              ...
              <Form.Group as={Row} controlId="formHorizontalImages">
                ...
                <Col sm={10}>
                  ...
                  {!this.props.edit ? (
                    ...
                    <Button as="label" htmlFor="files" variant="info" id="fileInput">Reupload files <Badge variant="light">{this.state.images.length}</Badge></Button>
                  )} 
                  {badQuant && (
                    <Alert variant="danger">
              ...
              <Form.Group as={Row} controlId="formHorizontalDescription">
                ...
                <Col sm={10}>
                  <Form.Control as="textarea" placeholder="Optional" value={this.state.description} onChange={this.onChangeDescription}/>
                </Col>
              </Form.Group>
              ...
              <Form.Group as={Row} controlId="formGridPrice">
                ...
                <Col sm={10}>
                  <InputGroup>
                    ...
                    <FormControl placeholder="0.00" value={this.state.price} onChange={this.onChangePrice} required/>
                    <InputGroup.Append>
              ...
              <Form.Group as={Row} controlId="formHorizontalBed">
                ...
                <Col sm={10}>
                  <Form.Control value={this.state.bed} onChange={this.onChangeBed} required/>
                </Col>
              </Form.Group>
              ...
              <Form.Group as={Row} controlId="formHorizontalBath">
                ...
                <Col sm={10}>
                  <Form.Control value={this.state.bath} onChange={this.onChangeBath} required/>
                </Col>
              </Form.Group>
                ...
                <Form.Group as={Row}>
                  ...
                  <Col sm={10}>
                    <Form.Check
                      ...
                      value="All"
                      checked={this.state.included.includes("All")} 
                    ...
                    <Form.Check
                      ...
                      name="formHorizontalCheckboxes"
                      value="Partial"
                      checked={this.state.included.includes("Partial")} 
                      onChange={this.onChangeIncluded}
                    />
                    <Form.Check
                      inline
                    ...
                    <Form.Check
                      ...
                      name="formHorizontalCheckboxes"
                      value="Laundry"
                      checked={this.state.included.includes("Laundry")} 
                      onChange={this.onChangeIncluded}
                    />
                    <Form.Check
                      inline
              ...
              <Form.Group as={Row} controlId="formGridContact">
                ...
                <Col sm={10}>
                  <Form.Group as={Row} controlId="formGridInstagram">
                    ...
                    <Col sm={10}>
                      <InputGroup>
                        ...
                        <FormControl value={this.state.contact.instagram} onChange={this.onChangeInstagram} />
                      </InputGroup>
                    </Col>
                  </Form.Group>
                  <Form.Group as={Row} controlId="formGridFacebook">
                    ...
                    <Col sm={10}>
                      <InputGroup>
                        ...
                        <FormControl value={this.state.contact.facebook} onChange={this.onChangeFacebook} />
                      </InputGroup>
                    </Col>
                  </Form.Group>
                  <Form.Group as={Row} controlId="formGridTwitter">
                    ...
                    <Col sm={10}>
                      <InputGroup>
                        ...
                        <FormControl value={this.state.contact.twitter} onChange={this.onChangeTwitter} />
                      </InputGroup>
                    </Col>
                  </Form.Group>
                  <Form.Group as={Row} controlId="formGridReddit">
                    ...
                    <Col sm={10}>
                      <InputGroup>
                        ...
                        <FormControl value={this.state.contact.reddit} onChange={this.onChangeReddit} />
                      </InputGroup>
                    </Col>
                  </Form.Group>
                  <Form.Group as={Row} controlId="formGridSnapchat">
                    ...
                    <Col sm={10}>
                      <InputGroup>
                        ...
                        <FormControl value={this.state.contact.snapchat} onChange={this.onChangeSnapchat} />
                      </InputGroup>
                    </Col>
                  </Form.Group>
                  <Form.Group as={Row} controlId="formGridWeChat">
                    ...
                    <Col sm={10}>
                      <InputGroup>
                        ...
                        <FormControl value={this.state.contact.wechat} onChange={this.onChangeWeChat} />
                      </InputGroup>
                    </Col>
                  </Form.Group>
                  <Form.Group as={Row} controlId="formGridPhone">
                    ...
                    <Col sm={10}>
                      <InputGroup>
                        <FormControl type="tel" value={this.state.contact.phone} onChange={this.onChangePhone} />
                      </InputGroup>
                    </Col>
                  </Form.Group>
                  <Form.Group as={Row} controlId="formGridEmail">
                    ...
                    <Col sm={10}>
                      <InputGroup>
                        <FormControl type="email" value={this.state.contact.email} onChange={this.onChangeEmail} />
                      </InputGroup>
                    </Col>
                  </Form.Group>
